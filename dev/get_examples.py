...
release --transfer --from-rel --to-bin ~/mnt/web/bin --palias guidelines
release --transfer --from-rel --to-bin ~/mnt/office-lw-vm/bin --palias guidelines --no-symlink
release --transfer --from-rel --to-rel ~/mnt/office-lw-vm/rel --palias guidelines
release --transfer --from-rel ~/fty/rel --to-rel ~/mnt/office-lw-vm/rel --palias guidelines
release --transfer --from-rel --to-rel ~/mnt/office-lw-vm/rel --palias message --pv 5.0.7
...
main.py --transfer --from-rel --to-bin --palias release
        """)